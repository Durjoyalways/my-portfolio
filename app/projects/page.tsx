              ...
              <div className="p-10 pt-2 space-y-6">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-3">
                    <Link href="#" className="w-12 h-12 bg-base-300 rounded-2xl flex items-center justify-center hover:bg-primary hover:text-black transition-all shadow-lg"><FaCode /></Link>
                    <Link href="#" className="w-12 h-12 bg-base-300 rounded-2xl flex items-center justify-center hover:bg-primary hover:text-black transition-all shadow-lg"><FaEye /></Link>
                  </div>
                </div>
